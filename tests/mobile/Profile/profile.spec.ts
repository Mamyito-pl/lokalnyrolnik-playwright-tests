...
test.describe('Testy profilu', async () => {
  ...
  test.describe('Przekierowania z modala profilu', () => {
    ...
    test('M | Po kliknięciu "Wyloguj się" w modalu profilu użytkownik jest zostaje wylogowany', { tag: ['@ProdSmoke', '@Smoke'] }, async ({ page, baseURL, mainPage, profilePage, nonLoggedUserPage }) => {
