...
test.describe('Testy płatności', async () => {
  ...
  test.describe('Płatność BLIK', () => {
    ...
    test('M | Zapłata nieprawidłowym kodem BLIK powinna utworzyć zamówienie', { tag: ['@ProdSmoke', '@Smoke'] }, async ({ page, paymentsPage, orderDetailsPage, cartPage, commonPage, baseURL, addProductsByValue }) => {
    ...
    test('M | Zapłata nieprawidłowym kodem BLIK', { tag: ['@Prod', '@Beta'] }, async ({ page, paymentsPage, orderDetailsPage, cartPage, commonPage, baseURL, addProductsByValue }) => {
  ...
  test.describe('Płatność kartą online', () => {
    ...
    test('M | Próba płatności kartą online powinna utworzyć zamówienie', { tag: ['@ProdSmoke', '@Smoke'] }, async ({ page, paymentsPage, ordersListPage, orderDetailsPage, cartPage, commonPage, baseURL, addProductsByValue }) => {
  ...
  test.describe('Płatność dpay', () => {
    ...
    test('M | Próba płatności dpay powinna utworzyć zamówienie', { tag: ['@ProdSmoke', '@Smoke'] }, async ({ page, paymentsPage, ordersListPage, orderDetailsPage, cartPage, commonPage, baseURL, addProductsByValue }) => {
