...
test.describe('Testy dane do faktury', async () => {
  ...
  test('W | Możliwość dodania danych do faktury', { tag: ['@ProdSmoke', '@Smoke'] }, async ({ page, deliveryPage, commonPage, invoiceAddressesPage }) => {
  ...
  test('W | Możliwość edycji danych do faktury', { tag: ['@ProdSmoke', '@Smoke'] }, async ({ page, deliveryPage, commonPage, invoiceAddressesPage, addInvoiceAddress }) => {
  ...
  test('W | Możliwość usunięcia danych do faktury', { tag: ['@ProdSmoke', '@Smoke'] }, async ({ page, deliveryPage, commonPage, invoiceAddressesPage, addInvoiceAddress }) => {
