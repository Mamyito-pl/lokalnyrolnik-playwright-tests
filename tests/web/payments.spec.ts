...
test.describe.fixme('Testy płatności', async () => {
  ...
  test.describe('Płatność BLIK', () => {
    ...
    test('W | Zapłata nieprawidłowym kodem BLIK powinna utworzyć zamówienie', { tag: ['@ProdSmoke'] }, async ({ page, paymentsPage, orderDetailsPage, cartPage, commonPage, deliveryPage, baseURL, addProductsByValue }) => {
  ...
  test.describe('Płatność dpay', () => {
    ...
    test('W | Próba płatności dpay powinna utworzyć zamówienie', { tag: ['@ProdSmoke'] }, async ({ page, paymentsPage, ordersListPage, orderDetailsPage, cartPage, commonPage, baseURL, addProductsByValue }) => {
