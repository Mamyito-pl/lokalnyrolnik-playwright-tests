...
test.describe('Testy dostawy', async () => {
  ...
  test('W | Możliwość wyboru formy dostawy', { tag: ['@ProdSmoke', '@Smoke'] }, async ({ page, deliveryPage, addAddressDeliveryViaAPI }) => {
  ...
  test.describe('Adres dostawy', async () => {
    ...
    test('W | Możliwość dodania adresu dostawy', { tag: ['@ProdSmoke', '@Smoke'] }, async ({ page, deliveryPage, commonPage }) => {
    ...
    test('W | Możliwość edycji adresu dostawy', { tag: ['@ProdSmoke', '@Smoke'] }, async ({ page, deliveryPage, commonPage, addAddressDeliveryViaAPI }) => {
    ...
    test('W | Możliwość usunięcia adresu dostawy', { tag: ['@ProdSmoke', '@Beta', '@Test'] }, async ({ page, deliveryPage, commonPage, addAddressDeliveryViaAPI }) => {
